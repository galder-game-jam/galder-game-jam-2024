...
#ifndef GALDER_GAME_JAM_2024_PROJECT_IPADDRESSRESOLVER_H
#define GALDER_GAME_JAM_2024_PROJECT_IPADDRESSRESOLVER_H
...
#endif //GALDER_GAME_JAM_2024_PROJECT_IPADDRESSRESOLVER_H
