...
#ifndef GALDER_GAME_JAM_2024_PROJECT_IIPADDRESSRESOLVER_H
#define GALDER_GAME_JAM_2024_PROJECT_IIPADDRESSRESOLVER_H
...
#endif //GALDER_GAME_JAM_2024_PROJECT_IIPADDRESSRESOLVER_H
