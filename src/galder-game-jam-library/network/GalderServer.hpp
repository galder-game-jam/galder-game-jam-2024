...
#ifndef GALDER_GAME_JAM_2024_PROJECT_GALDERSERVER_HPP
#define GALDER_GAME_JAM_2024_PROJECT_GALDERSERVER_HPP
        ...
        protected:
            ...
            void pollSpecialClientMessages()
            {
                ...
                while ( !m_quit )
                {
                    ...
                    PlayerNetworkData *dataPtr = (PlayerNetworkData*)incomingMsg->m_pData;
                    PlayerNetworkData data = (dataPtr != nullptr) ? *dataPtr : PlayerNetworkData();
...
#endif //GALDER_GAME_JAM_2024_PROJECT_GALDERSERVER_HPP
