#ifndef GAME_DEV_TEMPLATE_POWERUP_H
#define GAME_DEV_TEMPLATE_POWERUP_H
...
namespace ggj
{
    class PowerUp : public PhysicsSprite
    {
        public:
            PowerUp() = default;
            PowerUp(ggj::IAnimationManager<ggj::Animation, ggj::AnimationName> &animationManager, IMapper &mapper, b2Body *body, const raylib::Vector2 &physicsSize,
              ...
              m_velocity{velocity}
            {
                ...
                m_animation = m_animationManager.getAnimation(AnimationName::PowerUpCycle);
...
#endif //GAME_DEV_TEMPLATE_POWERUP_H